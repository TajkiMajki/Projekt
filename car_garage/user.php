...
<body data-aos-easing="ease-out-back" data-aos-duration="1500" data-aos-delay="0">
    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <p style="font-family: 'AbolitionW00-Regular';text-transform:capitalize;color:black;margin-top:100px;text-align:center;font-size:40px">Welcome <?php
            $query1="select name from customer where email='$email'";
            $nameg = mysqli_query($con,$query1);
            while ($row = mysqli_fetch_assoc($nameg)) {
                echo $row['name']."<br>";
    ...
    <div class="row">
        ...
        <div class="col-md-6">
        <p style="font-family:'AbolitionW00-Regular';font-size:30px;text-align:center;">Your upcoming visits</p>
        </div>
...
$count=1;
$email = $_SESSION["email"];
$g1="Select r.res_date,r.res_time,r.car_quantity
    from visits r
    where r.email='$email'";
...
while($row = mysqli_fetch_assoc($res2)) { ?>
            <tr>
                ...
                <td align="center"><?php echo $row["car_quantity"]; ?></td>
                 </td>
            </tr>
            <?php $count++; } ?>
        </tbody>
